...
export default class JVertexFlux extends JVertexGeneric {
  ...
  private static _maxFluxValues: IMaxFluxValues = {
    annualMaxFlux: 0,
    monthMaxFlux: getArrayOfN(12, 0)
  };
  static set maxFluxValues(mfv: IMaxFluxValues) { this._maxFluxValues = mfv }
  static get annualMaxFlux(): number { return this._maxFluxValues.annualMaxFlux }
  static get monthMaxFlux(): number[] { return this._maxFluxValues.monthMaxFlux }
